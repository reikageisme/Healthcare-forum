...
/**
 * Cổng tin tức medicvn.com.
 *
 * Giống hệt ứng dụng trước khi tách, trừ hai chỗ: không còn route diễn đàn
 * (đã dọn sang tên miền con), và /forum còn lại chỉ để hứng link cũ rồi đẩy
 * sang đó. Trang quản trị ở lại đây vì đây là nơi giữ danh tính và cây
 * chuyên mục — nguồn sự thật cho cả hai trang.
 */
